...
export default function KitCorretorPage() {
  ...
  return (
    <main className="min-h-screen bg-gray-50 flex flex-col justify-between">
      ...
      {/* RODAPÉ E CONTATOS (BLOCO DO POLVO) */}
      <div className="w-full mt-16 md:mt-24">
        
        {/* Bloco do Polvo e Redes Sociais */}
        <div className="w-full bg-[#064b5d] py-12 md:py-16">
          <div className="max-w-[1200px] mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-10">
            
            {/* Imagem do Polvo */}
            <div className="w-full md:w-1/2 flex justify-center md:justify-start">
              <div className="relative w-full max-w-[450px] aspect-[4/3] rounded-2xl overflow-hidden shadow-2xl border-4 border-white/10">
                <Image
            ...
            <div className="w-full md:w-1/2 flex flex-col items-center md:items-start text-center md:text-left text-white">
              ...
              <p className="text-white/80 mb-8 text-sm md:text-base max-w-md">
              ...
              <div className="flex flex-col sm:flex-row items-center gap-4 w-full justify-center md:justify-start">
                ...
                <div className="flex items-center gap-3 mt-4 sm:mt-0">
                  <a href="#" className="w-12 h-12 rounded-full bg-white/10 hover:bg-[#0c82a0] flex items-center justify-center transition-all hover:scale-110 shadow-lg" title="Instagram">
                  ...
                  <a href="#" className="w-12 h-12 rounded-full bg-white/10 hover:bg-[#0c82a0] flex items-center justify-center transition-all hover:scale-110 shadow-lg" title="Facebook">
                    <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
