  ...
  return (
    <main className="min-h-screen bg-gray-50 flex flex-col justify-between">
      ...
      <div className="w-full mt-16 md:mt-24 flex flex-col">
        ...
        {/* Bloco de Informações - Fundo Azul Marinho */}
        <div className="w-full bg-[#064b5d] py-16 px-6 text-center text-white">
          <div className="max-w-3xl mx-auto flex flex-col items-center">
            <h3 className="text-3xl md:text-4xl font-black mb-4 uppercase tracking-wide">
              Ocean Park
            </h3>
            <p className="text-white/80 mb-8 text-sm md:text-base max-w-lg">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 justify-center">
              ...
              <a
                ...
                className="bg-[#0c82a0] hover:bg-[#096a82] text-white px-8 py-3.5 rounded-full font-bold text-sm transition-all shadow-lg flex items-center gap-2 hover:scale-105"
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="flex items-center gap-3 mt-2 sm:mt-0">
                <a href="https://www.instagram.com/oceanparkosasco/" target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-full bg-white/10 hover:bg-[#0c82a0] flex items-center justify-center transition-all hover:scale-110 shadow-lg" title="Instagram">
                ...
                <a href="https://www.facebook.com/oceanparkosasco/" target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-full bg-white/10 hover:bg-[#0c82a0] flex items-center justify-center transition-all hover:scale-110 shadow-lg" title="Facebook">
                  <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
        ...
        {/* Imagem do Polvo - 100% da Largura da Tela */}
        ...
        {/* BARRA DE DIREITOS */}
        <div className="w-full bg-[#0c82a0] py-8 px-6 text-center text-white relative z-10">
